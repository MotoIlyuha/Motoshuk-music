...
const Seekbar = ({ value, min, max, onInput, setSeekTime, appTime }) => {
    ...
    return (
        <div className="hidden sm:flex flex-row items-center text-violet-200">
            <button type="button" onClick={() => setSeekTime(appTime - 5)}
                className="hidden lg:mr-4 lg:block">
                -
            </button>
            ...
            <input
                ...
                max={max}
                onInput={onInput}
                className="md:block w-24 md:w-56 2xl:w-96 h-1 mx-4 2xl:mx-6 rounded-lg accent-violet-500"
            />
